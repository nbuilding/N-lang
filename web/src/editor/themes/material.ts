...
// From https://gist.github.com/ElMatella/a5ffb4a486227887372c5a0d0abd0910
...
const themeData: monaco.editor.IStandaloneThemeData = {
  ...
  'colors': {
    // https://github.com/material-theme/vsc-material-theme/blob/master/scripts/generator/settings/specific/default.ts#L7-L35
    'editor.background': '#263238',
    'editor.backgroundAlt': '#263238',
    'editor.contrastBorder': '#263238',
    'editor.comments': '#546E7A',
    'editor.caret': '#FFCC00',
    'editor.findHighlight': '#FFCC00',
    'editor.foreground': '#EEFFFF',
    'editor.focusBorder': '#FFFFFF',
    'editor.guides': '#37474F',
    'editor.lineNumbers': '#37474F',
    'editor.invisibles': '#65737E',
    'editor.lineHighlight': '#000000',
    'editor.selection': '#80CBC420',
    'editor.shadow': '#00000030',
    'editor.inputBackground': '#303C41',
    'editor.inputForeground': '#EEFFFF',
    'editor.inputBorder': '#FFFFFF10',
    'editor.scrollbars': '#EEFFFF20',
    'editor.scrollbarsHover': '#EEFFFF10',
    'editor.statusbarForeground': '#546E7A',
    'editor.sidebarBackground': '#263238',
    'editor.sidebarForeground': '#607a86',
    'editor.listHoverForeground': '#FFFFFF',
    'editor.listHoverBackground': '#263238',
    'editor.tabActiveForeground': '#FFFFFF',
    'editor.inactiveSelectionBackground': '#00000030',
    ...
    // 'editorIndentGuide.activeBackground': '#80CBC4',
    // 'editor.selectionHighlightBorder': '#80CBC4'
  }
}
